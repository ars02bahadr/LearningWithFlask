...
class UserTypeCreate(Resource):
    ...
    def post(self):
        ...
        try:
            validated = schemas.UserTypeCreateSchema(**data)
...
class UserTypeUpdate(Resource):
    ...
    def put(self):
        ...
        try:
            validated = schemas.UserTypeUpdateSchema(**data)
        except ValidationError as ve:
            errors = ve.errors()
            return {
                "message": errors[0]['msg'] if errors else "Validation error",
